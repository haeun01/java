...
class GenericMethods { // 일반클래스 안에 정의한 제네릭 메소드 예제
    ...
    public <T> boolean method2(T t1, T t2) {  //1개의 제네릭 타입
        return t1.equals(t2);
    }
    ...
    //반드시 제네릭 T의 위치에 올 수 있는 모든 클래스들이 가능한 메서드만 쓸 수 있음
    public <T> void method5(T t) {
        //System.out.println(t.length()); //오류, Sting 클래스라고 단정할 수 없음
...
public class GenericMethod {
    public static void main(String[] args) {
        ...
        String str2 = gm.method1("안녕"); //<String>생략 (앞뒤 정보로 유추 가능하기 때문에)
