package Chap17.sec02_set.EX01_HashSetMethod;
...
public class HashSetMethod {
	public static void main(String[] args) {
		...
		hSet2.add("나");
		hSet2.add("다");
		hSet2.addAll(hSet1);  //순서와 상관없다.
		System.out.println(hSet2.toString()); //[가, 다, 나]
		
		//#3. remove(Object o)
		hSet2.remove("나");  //"나"를 지움
		...
		//#6. contains (Object o)
		//순서는 중요하지 않고 존재 여부가 중요함 (존재 여부를 묻는 문법)
		...
		//#8. iterator()
		// 눈 여겨 볼 필요가 있음
		// 순회 : iterator에 hSet3을 복사해서 hSet3 안을 순회한다.
		Iterator<String> iterator = hSet3.iterator();
		while(iterator.hasNext()) { //총 3바퀴
			//hasNext()_꺼낼게 있는지 없는지 물어보는 코드
			//들어있으면 하나씩 꺼내서 볼 수 있음
			System.out.println(iterator.next());
		}
		//일반적인 for은 Set가 인덱스가 없으므로 사용할 수 없지만 아래 방식으로는 가능함!
