...
select 주문번호, 고객번호, 주문일, 
	...
	day(주문일) as 주문일,
	weekday(주문일) as 주민요일,
	case weekday(주문일) when 0 then '월요일' when 1 then '화요일' when 1 then '수요일' when 1 then '목요일' when 1 then '금요일' when 1 then '토요일' when 1 then '일요일'
	end as 한글요일
from 주문;
