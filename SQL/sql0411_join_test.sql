...
/* 2. 주문, 주문세부, 제품 테이블을 조인하여 '아이스크림' 제품에 대하여 주문년도별 제품명별로 주문수량합을 보이시오. */
...
select 제품.제품번호, 제품명, sum(주문수량) as 주문수량합 from 주문세부
right join 제품 on 주문세부.제품번호 = 제품.제품번호 group by 제품명
order by 1;
